...
carousel.prototype = {
	left: function(){
		var width: number = this.obj.getElementsByClassName('carousel_item')[0].clientWidth,
			style: any = getComputedStyle(objList),
			left: number = Number(style.getPropertyValue("left").split('px')[0]),
